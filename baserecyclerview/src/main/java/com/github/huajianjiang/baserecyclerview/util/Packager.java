...
public class Packager {
    ...
    public static final int ITEM_VIEW_TYPE_HEADER = 0 << TYPE_SHIFT;
    public static final int ITEM_VIEW_TYPE_CLIENT = 1 << TYPE_SHIFT;
    public static final int ITEM_VIEW_TYPE_FOOTER = 2 << TYPE_SHIFT;
