...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    public SwipyRefreshLayout(Context context, AttributeSet attrs) {
        ...
        int colorSchemesId = a2.getResourceId(R.styleable.SwipyRefreshLayout_colorSchemes,
                R.array.color_schemes_default);
        TypedArray a3 = context.getResources().obtainTypedArray(colorSchemesId);
        final int count = a3.length();
        mColorSchemes = new int[count];
        for (int i = 0; i < count; i++) {
            mColorSchemes[i] = a3.getColor(i, 0xff000000);
        }
        a3.recycle();
        a2.recycle();
    ...
    private void createProgressView() {
        ...
        mProgress.setColorSchemeColors(mColorSchemes);
        mCircleView.setImageDrawable(mProgress);
        mCircleView.setVisibility(View.GONE);
        addView(mCircleView);
    }
