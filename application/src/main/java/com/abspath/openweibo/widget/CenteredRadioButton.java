...
/**
 * Title: 自定义内容居中的 {@link RadioButton},{@code} TextView 同理
 * <p>Description: 居中的内容包括 四个方向的 drawable 和 text
 * <p>Author: Huajian Jiang
 * <br>Date: 2017/3/1
 * <br>Email: developer.huajianjiang@gmail.com
 */
public class CenteredRadioButton extends android.support.v7.widget.AppCompatRadioButton {
    private static final String TAG = CenteredRadioButton.class.getSimpleName();
